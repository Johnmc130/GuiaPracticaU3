...
# ============================================================================
st.set_page_config(
    page_title="Análisis de Rendimiento Académico - ML",
    page_icon="🎓",
    layout="wide",
...
# Título principal
st.title("🎓 Análisis de Rendimiento Académico con Machine Learning")
...
<div style='text-align: center'>
    ...
    <p>Desarrollado con Streamlit | Dataset: academic_performance_master.csv</p>
</div>
